...
C------------------------------------------------------------------------------
      ...
      do k = 1, nu
        ...
        call old (idup(k), 'RO', upq(k,1), nq, ierr)

        if (nq .gt. nq_max) nq_max = nq
...
C moved        inflow(k) = idup(k)
        ...
        call old (idup(k), 'ro', upq(k,2), nq, ierr)
      ...
      do k = 1, nl
        ...
        call old (idlat(k), 'RO', latq(k), nq, ierr)
