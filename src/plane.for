...
C        dvf_delt = dvf_delt*1000.*3600./delt/FLOAT(nk-1)
...
!TEMP APR2015
!      write(789, '(i6,f8.2)') int(time/60.), rf*1000.*3600.
!      write(789, '(f8.2,100(",",f8.2))') q2(1)*1000.*3600./xleng,
!     &                         (q2(j)*1000.*3600./xleng, j = 2, nk)
